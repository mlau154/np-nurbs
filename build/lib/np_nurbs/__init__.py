...
def generate_cpu_coefficient_matrix(degree: int) -> np.ndarray[tuple[int, int], np.dtype[np.int_]]:
...
coefficient_matrices = {i: generate_cpu_coefficient_matrix(i) for i in range(32)}
